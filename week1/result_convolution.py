...
def conv_forward(A_prev, W, b, hparameters):
    ...
    for i in np.arange(m):                               # loop over the batch of training examples
        a_prev_pad = A_prev_pad[i]                               # Select ith training example's padded activation
        for h in np.arange(n_H):                           # loop over vertical axis of the output volume
            for w in np.arange(n_W):                       # loop over horizontal axis of the output volume
                for c in np.arange(n_C):                   # loop over channels (= #filters) of the output volume
